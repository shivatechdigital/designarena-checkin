...
Use [SEO_COPY_PASTE_GUIDE.md](documents%20markdown/SEO_COPY_PASTE_GUIDE.md) for ready-to-paste, page-specific SEO content and JSON-LD examples.
...
4. Run any one-time database migrations listed in [HOSTINGER_DEPLOYMENT.md](documents%20markdown/HOSTINGER_DEPLOYMENT.md) when updating an existing installation.
